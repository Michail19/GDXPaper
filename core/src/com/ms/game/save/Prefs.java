...
public class Prefs {
    ...
    private boolean a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a17, isVolumeOff, isMelOff;
    ...
    public Prefs() {
        ...
        isVolumeOff = preferences.getBoolean("IsVolumeOff");
        isMelOff = preferences.getBoolean("IsMelOff");
    }
    ...
    public void setVolumeOff() {
        ...
        preferences.putBoolean("IsVolumeOff", isVolumeOff);
        preferences.flush();
    }

    public boolean isMelOff() {
        return isMelOff;
    }

    public void setMelOff() {
        isMelOff = !isMelOff;
        preferences.putBoolean("IsMelOff", isMelOff);
        preferences.flush();
    }
    ...
    public void clearPrefs() {
        ...
        preferences.putBoolean("IsVolumeOff", false);
        preferences.putBoolean("IsMelOff", false);
        preferences.flush();
        preferences.clear();
    }
}
