...
public class Player {
    ...
    private int width;
    private int height;
    private Rectangle rectangle, rectangleL, rectangleM;
    ...
    public Player(float x, float y, int width, int height) {
        ...
        rectangleM.x = 265;
        rectangleM.y = 0;
        rectangleM.width = 335;
        rectangleM.height = 4200;
    }
    ...
    /**
     * Getter
     * @return - return rectangle collision for magnet
     */
    public Rectangle getRectangleM() {
        return rectangleM;
    }
}
